...
class TestJit(object):
    ...
    def test_add_list(self):
        ...
        a = torch.rand((3, 4))
        b = torch.rand((3, 4))
        rets = add_list._pyfunc(oper, x=a, y=b)
    ...
    def test_jit_no_full_shape(self):
        ...
        a = torch.rand((3, 4))
        b = torch.rand((3, 4))
        assert torch.allclose(func(a, b), func._pyfunc(a, b))
        assert len(func._cache._cache) == 1
