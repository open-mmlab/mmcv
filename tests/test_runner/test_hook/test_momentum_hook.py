...
# def test_cyclic_momentum_runner_hook(multi_optimizers, max_iters, gamma,
#                               cyclic_times):
...
# def test_step_momentum_runner_hook(multi_optimizers):
#     sys.modules['pavi'] = MagicMock()
#     runner = _build_demo_runner(multi_optimizers=multi_optimizers)
#     loader = DataLoader(torch.ones((10, 2)))
#     # add momentum scheduler
...
@pytest.mark.parametrize('multi_optimizers', [True, False])
def test_one_cycle_momentum_runner_hook(multi_optimizers):
    sys.modules['pavi'] = MagicMock()
    runner = _build_demo_runner(multi_optimizers=multi_optimizers)
    loader = DataLoader(torch.ones((10, 2)))
    # add momentum scheduler
