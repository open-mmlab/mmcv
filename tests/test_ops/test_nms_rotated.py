...
class TestNmsRotated(object):
    ...
    def test_ml_nms_rotated(self):
        ...
        np_boxes = np.array([[6.0, 3.0, 8.0, 7.0, 0.5, 0.7], [3.0, 6.0, 9.0, 11.0, 0.6, 0.8],
                             [3.0, 7.0, 10.0, 12.0, 0.3, 0.5], [1.0, 4.0, 13.0, 7.0, 0.6, 0.9]],
                            dtype=np.float32)
        np_labels = np.array([1, 0, 1, 0], dtype=np.float32)

        np_expect_dets = np.array([[1.0000,  4.0000, 13.0000,  7.0000,  0.6000],
                                   [3.0000,  6.0000,  9.0000, 11.0000,  0.6000],
                                   [6.0000,  3.0000,  8.0000,  7.0000,  0.5000]], dtype=np.float32)
    ...
    def test_nms_rotated(self):
        ...
        np_expect_dets = np.array([[1.0000,  4.0000, 13.0000,  7.0000,  0.6000],
                                   [3.0000,  6.0000,  9.0000, 11.0000,  0.6000],
                                   [6.0000,  3.0000,  8.0000,  7.0000,  0.5000],
                                   [3.0000,  7.0000, 10.0000, 12.0000,  0.3000]], dtype=np.float32)
