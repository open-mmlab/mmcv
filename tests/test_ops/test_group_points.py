...
def test_stack_grouping_points():
    ...
    output = grouping_operation(features, idx, features_batch_cnt,
                                indices_batch_cnt)
    expected_output = torch.tensor([[[-0.0380, -0.0380, 0.5798],
                                     [-0.1880, -0.1880, -0.7981],
                                     [-1.5724, -1.5724, -0.9280],
                                     [0.6905, 0.6905, -1.3311],
                                     [-0.3190, -0.3190, 1.3687],
                                     [0.7798, 0.7798, 0.9277],
                                     [-0.3693, -0.3693, -0.4164],
                                     [-0.9457, -0.9457, -1.8274],
                                     [-0.2942, -0.2942, 0.9268],
                                     [-1.8527, -1.8527, 0.8414]],
                                    [[0.5798, 0.5798, 0.5798],
