...
[![docs](https://img.shields.io/badge/docs-dev--2.x-blue)](https://mmcv.readthedocs.io/en/dev-2.x/)
...
See the [documentation](http://mmcv.readthedocs.io/en/dev-2.x) for more features and usage.
...
to install `mmcv-full==2.0.0rc0` with `CUDA 11.1` and `PyTorch 1.9.0`, use the following command:

```shell
pip install mmcv-full==2.0.0rc0 -f https://download.openmmlab.com/mmcv/dist/cu111/torch1.9.0/index.html
```
...
If you would like to build MMCV from source, please refer to the [guide](https://mmcv.readthedocs.io/en/dev-2.x/get_started/build.html).

## FAQ

If you face some installation issues, CUDA related issues or RuntimeErrors,
you may first refer to this [Frequently Asked Questions](https://mmcv.readthedocs.io/en/dev-2.x/faq.html).
