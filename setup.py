...
def get_extensions():
    ...
    if EXT_TYPE == 'parrots':
        ...
        try:
            ...
            # for macos, due to psutil.Process() has no method called 'cpu_affinity',
            # due to its own design which aims to let kernel manage cache affinity well.
            # Because of that, AttributeError will be invoked, and here set cpu_use = 4 by default.
            cpu_use = 4
