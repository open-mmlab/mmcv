...
- [Definition of custom operators in MMCV](#definition-of-custom-operators-in-mmcv)
  ...
  - [~~MMCVSyncBatchNorm~~](#mmcvsyncbatchnorm)
    - [Description](#description-15)
    - [Parameters](#parameters-15)
    - [Inputs](#inputs-15)
    - [Outputs](#outputs-15)
    - [Type Constraints](#type-constraints-15)
  - [MMCVMultiScaleDeformableAttn](#mmcvmultiscaledeformableattn)
    - [Description](#description-16)
    - [Parameters](#parameters-16)
    - [Inputs](#inputs-16)
    - [Outputs](#outputs-16)
    - [Type Constraints](#type-constraints-16)
  - [MMCVFusedBiasLeakyReLU](#mmcvfusedbiasleakyrelu)
    - [Description](#description-17)
    - [Parameters](#parameters-17)
    - [Inputs](#inputs-17)
    - [Outputs](#outputs-17)
    - [Type Constraints](#type-constraints-17)
  - [MMCVFusedBiasLeakyReLU](#mmcvfusedbiasleakyrelu-1)
...
Synchronized batch normalization of multi-GPU training.

### Parameters

| Type    | Parameter       | Description                                                    |
| ------- | --------------- | -------------------------------------------------------------- |
| `float`   | `momentum`        | The value used for the running_mean and running_var computation |
| `float`   | `eps`        | A value added to the denominator for numerical stability. Defaults to 1e-5 |
| `int`   | `group`        |  The process group to work on |
...
<dl>
<dt><tt>input</tt>: T</dt>
<dd>Input 4D tensor of shape (N, C, H, W)</dd>
<dt><tt>running_mean</tt>: T</dt>
<dd>The running mean values</dd>
<dt><tt>running_var</tt>: T</dt>
<dd>The running variance values</dd>
<dt><tt>weight</tt>: T</dt>
<dd>The learnable parameters of weight</dd>
<dt><tt>bias</tt>: T</dt>
<dd>The learnable parameters of bias</dd>
</dl>
...
<dl>
<dt><tt>output</tt>: T</dt>
<dd>Output tensor after sync batch normalization</dd>
</dl>
