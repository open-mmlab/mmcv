...
```shell
pip install 'mmcv-full>=2.0.0rc1' -f https://download.openmmlab.com/mmcv/dist/{cu_version}/{torch_version}/index.html
```
...
to install `mmcv-full==2.0.0rc1` with `CUDA 11.1` and `PyTorch 1.9.0`, use the following command:
