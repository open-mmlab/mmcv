...
def get_indice_pairs_3d_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of get_indice_pairs_3d_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of get_indice_pairs_3d_forward. "
