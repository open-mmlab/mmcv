...
def indice_maxpool_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of indice_maxpool_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of indice_maxpool_backward. "
