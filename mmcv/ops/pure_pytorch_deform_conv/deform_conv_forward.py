...
def deform_conv_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of deform_conv_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of deform_conv_forward. "
