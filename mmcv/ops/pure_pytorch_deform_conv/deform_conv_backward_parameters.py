...
def deform_conv_backward_parameters_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of deform_conv_backward_parameters.
    ...
    """
    warnings.warn(f"Using stub implementation of deform_conv_backward_parameters. "
