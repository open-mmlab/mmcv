...
def deform_conv_backward_input_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of deform_conv_backward_input.
    ...
    """
    warnings.warn(f"Using stub implementation of deform_conv_backward_input. "
