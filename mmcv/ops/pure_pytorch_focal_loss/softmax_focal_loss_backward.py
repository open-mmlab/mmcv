...
def softmax_focal_loss_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of softmax_focal_loss_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of softmax_focal_loss_backward. "
