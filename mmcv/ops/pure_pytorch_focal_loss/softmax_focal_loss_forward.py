...
def softmax_focal_loss_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of softmax_focal_loss_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of softmax_focal_loss_forward. "
