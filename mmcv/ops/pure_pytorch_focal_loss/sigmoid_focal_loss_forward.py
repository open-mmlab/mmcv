...
def sigmoid_focal_loss_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of sigmoid_focal_loss_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of sigmoid_focal_loss_forward. "
