...
def sigmoid_focal_loss_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of sigmoid_focal_loss_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of sigmoid_focal_loss_backward. "
