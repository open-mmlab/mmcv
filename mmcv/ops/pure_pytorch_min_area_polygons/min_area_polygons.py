...
def min_area_polygons_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of min_area_polygons.
    ...
    """
    warnings.warn(f"Using stub implementation of min_area_polygons. "
