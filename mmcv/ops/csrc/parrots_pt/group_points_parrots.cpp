...
void group_points_parrots(CudaContext& ctx, const SSElement& attr,
  ...
  group_points(b, c, n, npoints, nsample, points_tensor, idx_tensor, out_tensor);
}
...
void group_points_backward_parrots(CudaContext& ctx, const SSElement& attr,
  ...
  group_points_backward(b, c, n, npoints, nsample, grad_out_tensor, idx_tensor, grad_points_tensor);
}
