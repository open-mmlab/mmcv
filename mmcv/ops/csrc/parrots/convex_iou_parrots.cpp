...
#ifdef MMCV_WITH_DIOPI
void convex_iou_forward_cuda_parrots_diopi(CudaContext& ctx, const SSElement& attr,
...
void convex_giou_forward_cuda_parrots_diopi(CudaContext& ctx, const SSElement& attr,
                                      const OperatorBase::in_list_t& ins,
                                      OperatorBase::out_list_t& outs) {
  diopiContext dctx(ctx);
  diopiContextHandle_t ch = &dctx;
