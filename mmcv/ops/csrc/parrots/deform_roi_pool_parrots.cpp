...
void deform_roi_pool_forward_cuda_parrots_diopi(
  ...
  PARROTS_CALLDIOPI(diopiDeformRoiPoolMmcv(ch, output, input, rois, offset,
...
void deform_roi_pool_backward_cuda_parrots_diopi(
  ...
  PARROTS_CALLDIOPI(diopiDeformRoiPoolBackwardMmcv(
      ch, grad_input, grad_offset, grad_output, input, rois, offset,
      pooled_height, pooled_width, sampling_ratio, spatial_scale, gamma));
}
#else
/*void deform_roi_pool_forward_cuda(Tensor input, Tensor rois, Tensor offset,
 *                                  Tensor output, int pooled_height,
