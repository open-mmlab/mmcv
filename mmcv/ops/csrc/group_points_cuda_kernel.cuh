#ifndef GROUP_POINTS_CUDA_CUH
#define GROUP_POINTS_CUDA_CUH
...
__global__ void group_points_backward_cuda_kernel(
...
__global__ void group_points_cuda_kernel(int b, int c, int n, int npoints,
                                         int nsample,
