...
void pyramid_deformable_im2col_impl(Tensor data_im, Tensor data_offset,
                            ...
                            Tensor data_col) {
  DISPATCH_DEVICE_IMPL(pyramid_deformable_im2col_impl, data_im, data_offset, channels,
                       height, width, offsetheight, offsetwidth, ksize_h, ksize_w, pad_h, pad_w, stride_h,
                       stride_w, dilation_h, dilation_w,scale_h, scale_w, parallel_imgs,
...
void pyramid_deformable_col2im_impl(Tensor data_col, Tensor data_offset,
                            ...
                            const int parallel_imgs, const int deformable_group,
                            Tensor grad_im) {
  DISPATCH_DEVICE_IMPL(pyramid_deformable_col2im_impl, data_col, data_offset, channels,
                       height, width, offsetheight, offsetwidth, ksize_h, ksize_w, pad_h, pad_w, stride_h,
                       stride_w, dilation_h, dilation_w,scale_h, scale_w, parallel_imgs,
...
void pyramid_deformable_col2im_coord_impl(
  ...
  DISPATCH_DEVICE_IMPL(pyramid_deformable_col2im_coord_impl, data_col, data_im,
                       data_offset, channels, height, width,offsetheight, offsetwidth, ksize_h, ksize_w,
                       pad_h, pad_w, stride_h, stride_w, dilation_h, dilation_w,scale_h, scale_w,
                       parallel_imgs, deformable_group, grad_offset);
}

void pyramid_deform_conv_shape_check(at::Tensor input, at::Tensor offset,
...
//可能反了
void pyramid_deform_conv_forward(Tensor input, Tensor weight, Tensor offset,
                         Tensor output, Tensor columns, Tensor ones, int kW,
                         int kH, int dW, int dH, int padW, int padH,
                         int dilationW, int dilationH, float scaleW, float scaleH, int group,
  ...
  pyramid_deform_conv_shape_check(input, offset, NULL, weight, kH, kW, dH, dW, padH,
  ...
  for (int elt = 0; elt < batchSize / im2col_step; elt++) {
    pyramid_deformable_im2col_impl(input[elt], offset[elt], nInputPlane, inputHeight,
                           inputWidth, offsetHeight, offsetWidth, kH, kW, padH, padW, dH, dW, dilationH,
                           dilationW, scaleH, scaleW, im2col_step, deformable_group, columns);
...
void pyramid_deform_conv_backward_input(Tensor input, Tensor offset, Tensor gradOutput,
  ...
  pyramid_deform_conv_shape_check(input, offset, &gradOutput, weight, kH, kW, dH, dW,
  ...
  for (int elt = 0; elt < batchSize / im2col_step; elt++) {
    ...
    pyramid_deformable_col2im_coord_impl(columns, input[elt], offset[elt], nInputPlane,
                                 inputHeight, inputWidth, offsetHeight, offsetWidth, kH, kW, padH, padW,
                                 dH, dW, dilationH, dilationW,scaleH, scaleW, im2col_step,
                                 deformable_group, gradOffset[elt]);

    pyramid_deformable_col2im_impl(columns, offset[elt], nInputPlane, inputHeight,
                           inputWidth, offsetHeight, offsetWidth, kH, kW, padH, padW, dH, dW, dilationH,
                           dilationW, scaleH, scaleW,im2col_step, deformable_group,
                           gradInput[elt]);
...
void pyramid_deform_conv_backward_parameters(Tensor input, Tensor offset,
  ...
  pyramid_deform_conv_shape_check(input, offset, &gradOutput, gradWeight, kH, kW, dH,
