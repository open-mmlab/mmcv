...
{
  return DISPATCH_DEVICE_IMPL(filtered_lrelu_act_op_impl, x, si, sx, sy, gain, slope, clamp, writeSigns);
}
...
{
  return filtered_lrelu_act_op_impl(x, si, sx, sy, gain, slope, clamp, writeSigns);
}
