...
void ms_deformable_im2col_cuda(cudaStream_t stream,
  ...
  const int num_kernels = batch_size *
    num_query * num_heads * channels;
  const int num_actual_kernels = batch_size *
    num_query * num_heads * channels;
...
void ms_deformable_col2im_cuda(cudaStream_t stream,
  ...
  if (channels > 1024) {
    ...
    switch (channels) {
      case 1:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 1> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 2:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 2> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 4:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 4> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 8:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 8> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 16:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 16> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 32:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 32> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 64:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 64> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 128:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 128> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 256:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 256> //NOLINT
        ...
        break;
      case 512:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 512> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
        ...
        break;
      case 1024:
        ms_deformable_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 1024> //NOLINT
        <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads,
            0, stream>>>(
                      num_kernels,
                      grad_col,
...
at::Tensor ms_deform_attn_cuda_forward(
    ...
    AT_ASSERTM(value.is_contiguous(),
    ...
    AT_ASSERTM(attn_weight.type().is_cuda(),
    ...
    auto output = at::zeros({batch, num_query,
        num_heads, channels}, value.options());

    const int batch_n = im2col_step_;
    auto output_n = output.view({batch/im2col_step_,
        batch_n, num_query, num_heads, channels});
    auto per_value_size = spatial_size * num_heads * channels;
    auto per_sample_loc_size = num_query *
        ...
        AT_DISPATCH_FLOATING_TYPES(value.type(),
         "ms_deform_attn_forward_cuda", ([&] {
            ms_deformable_im2col_cuda(at::cuda::getCurrentCUDAStream(),
                ...
                sampling_loc.data<scalar_t>() + n *
                im2col_step_ * per_sample_loc_size,
                attn_weight.data<scalar_t>() + n *
                im2col_step_ * per_attn_weight_size,
                batch_n, spatial_size, num_heads,
...
std::vector<at::Tensor> ms_deform_attn_cuda_backward(
    ...
    const int batch_n = im2col_step_;
    auto per_value_size = spatial_size * num_heads * channels;
    auto per_sample_loc_size = num_query * num_heads *
        num_levels * num_point * 2;
    auto per_attn_weight_size = num_query * num_heads *
        num_levels * num_point;
    auto grad_output_n = grad_output.view({batch/im2col_step_,
        batch_n, num_query, num_heads, channels});
