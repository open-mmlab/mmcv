...
void prroi_pool_coor_backward_cuda(Tensor output, Tensor grad_output, Tensor input,
                            Tensor rois, Tensor grad_rois, int pooled_height,
                            int pooled_width, float spatial_scale) {
  PrROIPoolCoorBackwardCUDAKernelLauncher(output, grad_output, input, rois,
                            grad_rois, pooled_height, pooled_width, spatial_scale);
}
...
REGISTER_DEVICE_IMPL(prroi_pool_coor_backward_impl, CUDA, prroi_pool_coor_backward_cuda);
