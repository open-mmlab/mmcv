...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("pyramid_deform_conv_forward", &pyramid_deform_conv_forward, "pyramid_deform_conv_forward",
        py::arg("input"), py::arg("weight"), py::arg("offset"),
        py::arg("output"), py::arg("columns"), py::arg("ones"), py::arg("kW"),
        py::arg("kH"), py::arg("dW"), py::arg("dH"), py::arg("padH"),
        py::arg("padW"), py::arg("dilationW"), py::arg("dilationH"),py::arg("scaleW"), py::arg("scaleH"),
        py::arg("group"), py::arg("deformable_group"), py::arg("im2col_step"));
  m.def("pyramid_deform_conv_backward_input", &pyramid_deform_conv_backward_input,
        "pyramid_deform_conv_backward_input", py::arg("input"), py::arg("offset"),
        py::arg("gradOutput"), py::arg("gradInput"), py::arg("gradOffset"),
        py::arg("weight"), py::arg("columns"), py::arg("kW"), py::arg("kH"),
        py::arg("dW"), py::arg("dH"), py::arg("padH"), py::arg("padW"),
        py::arg("dilationW"), py::arg("dilationH"), py::arg("scaleW"), py::arg("scaleH"),py::arg("group"),
        py::arg("deformable_group"), py::arg("im2col_step"));
  m.def("pyramid_deform_conv_backward_parameters", &pyramid_deform_conv_backward_parameters,
        "pyramid_deform_conv_backward_parameters", py::arg("input"), py::arg("offset"),
        py::arg("gradOutput"), py::arg("gradWeight"), py::arg("columns"),
        py::arg("ones"), py::arg("kW"), py::arg("kH"), py::arg("dW"),
        py::arg("dH"), py::arg("padH"), py::arg("padW"), py::arg("dilationW"),
        py::arg("dilationH"),py::arg("scaleW"), py::arg("scaleH"), py::arg("group"), py::arg("deformable_group"),
        py::arg("scale"), py::arg("im2col_step"));
