...
void rotated_feature_align_forward_impl(const Tensor features,
                                 ...
                                 Tensor output) {
  DISPATCH_DEVICE_IMPL(rotated_feature_align_forward_impl, features, best_bboxes,
...
void rotated_feature_align_backward_impl(const Tensor top_grad,
                                  ...
                                  const float spatial_scale, const int points,
                                  Tensor bottom_grad) {
  DISPATCH_DEVICE_IMPL(rotated_feature_align_backward_impl, top_grad, best_bboxes,
...
void rotated_feature_align_forward(const Tensor features, const Tensor best_bboxes,
                            ...
                            const int points) {
  rotated_feature_align_forward_impl(features, best_bboxes, spatial_scale, points,
                              output);
}
...
void rotated_feature_align_backward(const Tensor top_grad, const Tensor best_bboxes,
                             ...
                             const int points) {
  rotated_feature_align_backward_impl(top_grad, best_bboxes, spatial_scale, points,
                               bottom_grad);
}
