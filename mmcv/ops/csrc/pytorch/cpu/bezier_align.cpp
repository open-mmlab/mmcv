...
void BezierAlignForward(
    ...
    bool aligned, const int channels,
    const int height,
    const int width)
{
...
template <typename T>
void BezierAlignBackward(const int nthreads, const T *grad_output, const T *rois,
                         T *grad_input,
                         const int pooled_height, const int pooled_width,
                         const T &spatial_scale, const int sampling_ratio,
                         bool aligned, const int channels, const int height,
                                    ...
                                    bool aligned)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      ...
      { BezierAlignBackward<scalar_t>(
            ...
            sampling_ratio, aligned, channels, height, width,
