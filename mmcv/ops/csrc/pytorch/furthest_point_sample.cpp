...
void stack_furthest_point_sampling_forward_impl(
  ...
  DISPATCH_DEVICE_IMPL(stack_furthest_point_sampling_forward_impl,
                       points_tensor, temp_tensor, xyz_batch_cnt_tensor,
...
void stack_furthest_point_sampling_forward(Tensor points_tensor,
  ...
  stack_furthest_point_sampling_forward_impl(points_tensor, temp_tensor,
                                             xyz_batch_cnt_tensor, idx_tensor,
