...
void modulated_deformable_im2col_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data_im.scalar_type(), "modulated_deformable_im2col_gpu", ([&] {
        ...
        hipLaunchKernelGGL(modulated_deformable_im2col_gpu_kernel, dim3(GET_BLOCKS(num_kernels)), dim3(THREADS_PER_BLOCK), 0, at::hip::getCurrentHIPStream(), 
...
void modulated_deformable_col2im_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data_col.scalar_type(), "modulated_deformable_col2im_gpu", ([&] {
        ...
        hipLaunchKernelGGL(modulated_deformable_col2im_gpu_kernel, dim3(GET_BLOCKS(num_kernels)), dim3(THREADS_PER_BLOCK), 0, at::hip::getCurrentHIPStream(), 
...
void modulated_deformable_col2im_coord_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data_col.scalar_type(), "modulated_deformable_col2im_coord_gpu", ([&] {
        ...
        hipLaunchKernelGGL(modulated_deformable_col2im_coord_gpu_kernel, dim3(GET_BLOCKS(num_kernels)), dim3(THREADS_PER_BLOCK), 0, at::hip::getCurrentHIPStream(), 
