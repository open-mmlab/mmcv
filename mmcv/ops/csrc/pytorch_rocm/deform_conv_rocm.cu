...
void deformable_im2col(Tensor data_im, Tensor data_offset, const int channels,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data_im.scalar_type(), "deformable_im2col_gpu", ([&] {
        ...
        hipLaunchKernelGGL(deformable_im2col_gpu_kernel, dim3(GET_BLOCKS(num_kernels)), dim3(THREADS_PER_BLOCK), 0, at::hip::getCurrentHIPStream(), 
...
void deformable_col2im(Tensor data_col, Tensor data_offset, const int channels,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data_col.scalar_type(), "deformable_col2im_gpu", ([&] {
        ...
        hipLaunchKernelGGL(deformable_col2im_gpu_kernel, dim3(GET_BLOCKS(num_kernels)), dim3(THREADS_PER_BLOCK), 0, at::hip::getCurrentHIPStream(), 
...
void deformable_col2im_coord(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data_col.scalar_type(), "deformable_col2im_coord_gpu", ([&] {
        ...
        hipLaunchKernelGGL(deformable_col2im_coord_gpu_kernel, dim3(GET_BLOCKS(num_kernels)), dim3(THREADS_PER_BLOCK), 0, at::hip::getCurrentHIPStream(), 
