#ifndef FURTHEST_POINT_SAMPLE_CUDA_CUH
#define FURTHEST_POINT_SAMPLE_CUDA_CUH
...
template <unsigned int block_size>
__global__ void furthest_point_sampling_with_dist_cuda_kernel(
    int b, int n, int m, const float *__restrict__ dataset,
    float *__restrict__ temp, int *__restrict__ idxs) {
  // dataset: (B, N, N)
  // tmp: (B, N)
...
#endif  // FURTHEST_POINT_SAMPLE_CUDA_CUH
