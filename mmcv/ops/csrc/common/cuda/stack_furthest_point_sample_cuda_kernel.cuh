...
__device__ void update(float *__restrict__ dists, int *__restrict__ dists_i, int idx1, int idx2){
...
__global__ void stack_farthest_point_sample_cuda_kernel(int batch_size, int N,
