...
void setMTLArgsImpl(MTLComputeCommandEncoder_t encoder, int index, T&& t,
                    Args&&... args) {
...
void setMTLArgs(MTLComputeCommandEncoder_t encoder,
                MTLComputePipelineState_t pso, Args&&... args) {
