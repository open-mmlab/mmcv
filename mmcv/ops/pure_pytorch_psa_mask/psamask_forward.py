...
def psamask_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of psamask_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of psamask_forward. "
