...
def psamask_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of psamask_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of psamask_backward. "
