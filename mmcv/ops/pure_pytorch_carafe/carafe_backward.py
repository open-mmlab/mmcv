...
def carafe_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of carafe_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of carafe_backward. "
