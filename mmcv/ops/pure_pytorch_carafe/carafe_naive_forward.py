...
def carafe_naive_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of carafe_naive_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of carafe_naive_forward. "
