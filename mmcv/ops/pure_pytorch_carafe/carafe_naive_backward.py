...
def carafe_naive_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of carafe_naive_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of carafe_naive_backward. "
