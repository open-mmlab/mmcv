...
def three_nn_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of three_nn_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of three_nn_forward. "
