...
def furthest_point_sampling_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of furthest_point_sampling_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of furthest_point_sampling_forward. "
