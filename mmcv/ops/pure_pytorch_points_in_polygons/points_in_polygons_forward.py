...
def points_in_polygons_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of points_in_polygons_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of points_in_polygons_forward. "
