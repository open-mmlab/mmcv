...
ext_module = ext_loader.load_ext('_ext', [
    'pyramid_deform_conv_forward', 'pyramid_deform_conv_backward_input',
    'pyramid_deform_conv_backward_parameters'
])


class pyramid_DeformConv2dFunction(Function):
    ...
    def forward(ctx,
        ...
        output = input.new_empty(
            pyramid_DeformConv2dFunction._output_size(offset, weight, ctx.padding,
        ...
        ext_module.pyramid_deform_conv_forward(
            input,
            weight,
            offset,
            output,
    ...
    def backward(ctx, grad_output):
        ...
        if ctx.needs_input_grad[0] or ctx.needs_input_grad[1]:
            ...
            ext_module.pyramid_deform_conv_backward_input(
                input,
                offset,
                grad_output,
                grad_input,
...
pyramid_deform_conv2d = pyramid_DeformConv2dFunction.apply


class pyramid_DeformConv2d(nn.Module):
    ...
    def __init__(self,
        ...
        super(pyramid_DeformConv2d, self).__init__()
    ...
    def forward(self, x: Tensor, offset: Tensor, scale_h: Tensor, scale_w: Tensor) -> Tensor:
        ...
        out = pyramid_deform_conv2d(x, offset, self.weight, scales,self.stride, self.padding,
...
class pyramid_DeformConv2dPack(pyramid_DeformConv2d):
    ...
    def __init__(self, *args, **kwargs):
        super(pyramid_DeformConv2dPack, self).__init__(*args, **kwargs)
    ...
    def forward(self, x):
        ...
        return pyramid_deform_conv2d(x, offset, self.weight, self.stride, self.padding,
                             self.dilation, self.groups, self.deform_groups,
                             False, self.im2col_step)
