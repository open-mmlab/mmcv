...
def stack_group_points_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of stack_group_points_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of stack_group_points_backward. "
