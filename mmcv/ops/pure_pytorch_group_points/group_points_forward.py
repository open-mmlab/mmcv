...
def group_points_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of group_points_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of group_points_forward. "
