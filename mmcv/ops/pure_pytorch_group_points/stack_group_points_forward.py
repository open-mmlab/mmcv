...
def stack_group_points_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of stack_group_points_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of stack_group_points_forward. "
