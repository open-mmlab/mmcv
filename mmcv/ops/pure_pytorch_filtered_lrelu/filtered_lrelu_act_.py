...
def filtered_lrelu_act__pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of filtered_lrelu_act_.
    ...
    """
    warnings.warn(f"Using stub implementation of filtered_lrelu_act_. "
