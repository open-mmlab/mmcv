...
def fused_bias_leakyrelu_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of fused_bias_leakyrelu.
    ...
    """
    warnings.warn(f"Using stub implementation of fused_bias_leakyrelu. "
