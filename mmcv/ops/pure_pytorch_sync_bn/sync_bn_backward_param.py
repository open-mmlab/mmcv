...
def sync_bn_backward_param_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of sync_bn_backward_param.
    ...
    """
    warnings.warn(f"Using stub implementation of sync_bn_backward_param. "
