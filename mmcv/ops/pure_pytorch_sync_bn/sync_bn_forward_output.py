...
def sync_bn_forward_output_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of sync_bn_forward_output.
    ...
    """
    warnings.warn(f"Using stub implementation of sync_bn_forward_output. "
