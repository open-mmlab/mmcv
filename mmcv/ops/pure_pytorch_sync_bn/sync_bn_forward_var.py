...
def sync_bn_forward_var_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of sync_bn_forward_var.
    ...
    """
    warnings.warn(f"Using stub implementation of sync_bn_forward_var. "
