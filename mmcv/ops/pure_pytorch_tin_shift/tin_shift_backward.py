...
def tin_shift_backward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of tin_shift_backward.
    ...
    """
    warnings.warn(f"Using stub implementation of tin_shift_backward. "
