...
def tin_shift_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of tin_shift_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of tin_shift_forward. "
