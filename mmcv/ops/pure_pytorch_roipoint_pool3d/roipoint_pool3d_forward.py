...
def roipoint_pool3d_forward_pytorch(*args, **kwargs):
    """
    PyTorch-only stub implementation of roipoint_pool3d_forward.
    ...
    """
    warnings.warn(f"Using stub implementation of roipoint_pool3d_forward. "
