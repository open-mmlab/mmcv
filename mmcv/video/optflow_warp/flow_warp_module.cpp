...
static const char __pyx_k_flow_warp_func[] = "flow_warp_func";
...
static PyObject *__pyx_n_s_flow_warp_func;
...
static PyObject *__pyx_pf_4mmcv_4_ext_flow_warp_func(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_img_array, PyArrayObject *__pyx_v_flow_array, int __pyx_v_ignore_label, int __pyx_v_interpolate_mode); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4mmcv_4_ext_1flow_warp_func(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4mmcv_4_ext_1flow_warp_func = {"flow_warp_func", (PyCFunction)__pyx_pw_4mmcv_4_ext_1flow_warp_func, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4mmcv_4_ext_1flow_warp_func(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_img_array = 0;
  PyArrayObject *__pyx_v_flow_array = 0;
  int __pyx_v_ignore_label;
  int __pyx_v_interpolate_mode;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("flow_warp_func (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_img_array,&__pyx_n_s_flow_array,&__pyx_n_s_ignore_label,&__pyx_n_s_interpolate_mode,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_flow_array)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("flow_warp_func", 0, 2, 4, 1); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "flow_warp_func") < 0)) __PYX_ERR(0, 14, __pyx_L3_error)
      }
    } else {
    ...
    if (values[2]) {
      __pyx_v_ignore_label = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_ignore_label == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    } else {
      __pyx_v_ignore_label = ((int)0);
    }
    if (values[3]) {
      __pyx_v_interpolate_mode = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_interpolate_mode == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("flow_warp_func", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("mmcv._ext.flow_warp_func", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_img_array), __pyx_ptype_5numpy_ndarray, 0, "img_array", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_flow_array), __pyx_ptype_5numpy_ndarray, 0, "flow_array", 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_r = __pyx_pf_4mmcv_4_ext_flow_warp_func(__pyx_self, __pyx_v_img_array, __pyx_v_flow_array, __pyx_v_ignore_label, __pyx_v_interpolate_mode);
...
static PyObject *__pyx_pf_4mmcv_4_ext_flow_warp_func(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_img_array, PyArrayObject *__pyx_v_flow_array, int __pyx_v_ignore_label, int __pyx_v_interpolate_mode) {
  ...
  int __pyx_t_6;
  int __pyx_t_7;
  __Pyx_RefNannySetupContext("flow_warp_func", 0);
  ...
  __pyx_pybuffernd_flow_array.rcbuffer = &__pyx_pybuffer_flow_array;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_img_array.rcbuffer->pybuffer, (PyObject*)__pyx_v_img_array, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 14, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_flow_array.rcbuffer->pybuffer, (PyObject*)__pyx_v_flow_array, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 14, __pyx_L1_error)
  }
 ...
 */
  ...
  if (!__pyx_t_2) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_3, ((PyObject *)__pyx_v_img_array)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 *              out_array.shape[1],
 */
  if (!(likely(((__pyx_v_out_array) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_out_array, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 *              ignore_label,
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_out_array, __pyx_n_s_shape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  /* "mmcv/video/optflow_warp/flow_warp_module.pyx":26
 *              out_array.shape[0],
 *              out_array.shape[1],
 *              out_array.shape[2],             # <<<<<<<<<<<<<<
 *              ignore_label,
 *              interpolate_mode)
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_out_array, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *              <double*> np.PyArray_DATA(out_array),
 */
  flowWarp(((double *)PyArray_DATA(((PyArrayObject *)__pyx_v_img_array))), ((double *)PyArray_DATA(((PyArrayObject *)__pyx_v_flow_array))), ((double *)PyArray_DATA(((PyArrayObject *)__pyx_v_out_array))), __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_v_ignore_label, __pyx_v_interpolate_mode);

  /* "mmcv/video/optflow_warp/flow_warp_module.pyx":30
 *              interpolate_mode)
 * 
 *     return out_array             # <<<<<<<<<<<<<<
 * 
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_flow_warp_func, __pyx_k_flow_warp_func, sizeof(__pyx_k_flow_warp_func), 0, 0, 1, 1},
 ...
 *                    int ignore_label=0,
 */
  __pyx_tuple__10 = PyTuple_Pack(5, __pyx_n_s_img_array, __pyx_n_s_flow_array, __pyx_n_s_ignore_label, __pyx_n_s_interpolate_mode, __pyx_n_s_out_array); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mmcv_video_optflow_warp_flow_war, __pyx_n_s_flow_warp_func, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                    int ignore_label=0,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4mmcv_4_ext_1flow_warp_func, NULL, __pyx_n_s_mmcv__ext); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_flow_warp_func, __pyx_t_1) < 0) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
