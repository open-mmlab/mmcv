...
int CARAFEForwardCUDAKernelLauncher(
    const Tensor features, const Tensor masks,
    Tensor rfeatures, Tensor routput, Tensor rmasks, Tensor output,
...
int carafe_backward_cuda(
    ...
    return CARAFEBackwardCUDAKernelLauncher(
...
int carafe_backward(
    ...
    if (top_grad.device().is_cuda()) {
        ...
        return carafe_backward_cuda(
                   top_grad, rfeatures, masks, rtop_grad, rbottom_grad_hs,
