...
int ModulatedDeformConvForwardCUDALauncher(
...
int ModulatedDeformConvBackwardCUDALauncher(
    Tensor input, Tensor weight, Tensor bias, Tensor ones,
...
int modulated_deform_conv_forward(
    ...
    if (input.device().is_cuda()) {
        ...
        ModulatedDeformConvForwardCUDALauncher(
...
int modulated_deform_conv_backward(
    ...
    if (input.device().is_cuda()) {
        ...
        ModulatedDeformConvBackwardCUDALauncher(
