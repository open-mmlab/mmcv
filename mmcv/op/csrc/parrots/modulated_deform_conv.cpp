...
int ModulatedDeformConvForwardCUDAKernelLauncher(
    ...
    DArrayLite output, DArrayLite columns, 
    int kernel_h, int kernel_w, const int stride_h, const int stride_w,
    const int pad_h, const int pad_w, const int dilation_h,
    const int dilation_w, const int group, int deformable_group,
    const bool with_bias, CudaContext& ctx, cudaStream_t stream);

int ModulatedDeformConvBackwardCUDAKernelLauncher(
    const DArrayLite input, const DArrayLite weight, const DArrayLite bias,
    const DArrayLite ones, const DArrayLite offset, const DArrayLite mask,
    DArrayLite columns, DArrayLite grad_input, DArrayLite grad_weight, DArrayLite grad_bias,
...
void modulated_deform_conv_cuda_forward(
    ...
    ModulatedDeformConvForwardCUDAKernelLauncher(
        ...
        dilation_h, dilation_w, group, deformable_group,
        with_bias, ctx, stream);
}
