...
- [ruff](https://docs.astral.sh/ruff/): A fast Python linter and formatter, written in Rust, that replaces several tools like flake8, isort, and black.
- [codespell](https://github.com/codespell-project/codespell): A Python utility to fix common misspellings in text files.
- [mdformat](https://github.com/executablebooks/mdformat): Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
- [docformatter](https://github.com/myint/docformatter): A formatter to format docstring.

Style configurations for ruff can be found in [pyproject.toml](./pyproject.toml).

We use [pre-commit hook](https://pre-commit.com/) that checks and formats for `ruff`, `trailing whitespaces`, `markdown files`,
